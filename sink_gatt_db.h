...
#define HANDLE_BATTERY_SERVICE1         (0x000a)
#define HANDLE_BATTERY_SERVICE1_END     (0xffff)
#define HANDLE_BATTERY_LEVEL1           (0x000c)
#define HANDLE_BATTERY_LEVEL_PRESENTATION1 (0x000d)
#define HANDLE_BATTERY_LEVEL_CLIENT_CONFIG1 (0x000e)
