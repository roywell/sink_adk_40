...
void configManagerReadSessionData( void )
{
    ...
    theSink.volume_levels->fm_volume = lTemp.fm_volume;
#endif   
...
void configManagerWriteSessionData( void )
{
    ...
    lTemp.fm_volume         = theSink.volume_levels->fm_volume;
#else
    lTemp.fm_frequency          = 0;
    lTemp.fm_volume.main_volume = 0;
    lTemp.fm_volume.aux_volume  = 0;
#endif    
